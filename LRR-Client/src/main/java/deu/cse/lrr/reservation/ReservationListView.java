...
public class ReservationListView extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ReservationListView.class.getName());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("내 예약 조회 결과");

        jButton1.setText("취소하기");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ReservationListView().setVisible(true));
    }
